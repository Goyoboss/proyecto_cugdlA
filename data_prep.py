...
#Aseguramos que no hay ningun valor nulo (copiado de Iván Toledano😢)
...
#Con los datos limpios se sacan las carreras que ha hecho Hamilton
def df_raikk():
    return df_psdrstan[df_psdrstan['driverRef']=='raikkonen']
